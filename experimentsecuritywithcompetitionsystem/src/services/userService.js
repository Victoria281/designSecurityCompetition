        ...
        return new Promise((resolve, reject) => {
            ...
            pool.getConnection((err, connection) => {
                if (err) {
                    ...
                    connection.query(`SELECT user_id, fullname, email, user.role_id, role_name 
                    FROM user INNER JOIN role ON user.role_id = role.role_id WHERE user_id= ?`, [recordId], (err, results) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(results);
        ...
        return new Promise((resolve, reject) => {
            ...
            pool.getConnection((err, connection) => {
                if (err) {
                    ...
                    connection.query(`SELECT user_id, fullname, email, user.role_id, role_name 
                    FROM user INNER JOIN role ON user.role_id = role.role_id WHERE email=?`, [search], (err, results) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(results);
        ...
        return new Promise((resolve, reject) => {
            ...
            pool.getConnection((err, connection) => {
                if (err) {
                    ...
                    connection.query(`SELECT file_id,cloudinary_file_id,cloudinary_url,design_title,design_description 
                    FROM file WHERE file_id=? AND created_by_id=?`, [recordId, userid], (err, results) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(results);
...
module.exports.updateDesign = (userid, recordId, title, description) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            pool.getConnection((err, connection) => {
                if (err) {
                    ...
                    connection.query(`UPDATE file SET design_title ='${title}' , design_description='${description}' WHERE file_id=${recordId} AND created_by_id=${userid}`, (err, rows) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(rows);
